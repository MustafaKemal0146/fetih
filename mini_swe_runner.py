#!/usr/bin/env python3
"""
SWE Runner with FETIH Trajectory Format

A runner that uses FETIH-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the FETIH-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses FETIH-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in FETIH format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches FETIH-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using FETIH-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with FETIH Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses FETIH-Agent's built-in execution environments
    and outputs trajectories in FETIH-Agent format.
    """
    ...
    def _convert_to_fetih_format(
        ...
        """
        Convert internal message format to FETIH trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to FETIH trajectory format
        trajectory = self._convert_to_fetih_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with FETIH trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with FETIH Trajectory Format")
    print("=" * 60)
