...
projection into FETIH' display, approval bridging, transcript projection into
...
"codex_app_server"`. FETIH' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("FETIH_KANBAN_TASK"):
            kanban_db = spawn_env.get("FETIH_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "FETIH_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("FETIH_HOME", os.path.expanduser("~/.fetih")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "fetih",
        client_title: str = "FETIH",
