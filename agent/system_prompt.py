...
upstream prefix cache warm.  See ``fetih-agent-dev``'s
...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    AIAgent.  FETIH never re-renders parts of this string mid-
    ...
    # Some execution modes (cron) still want FETIH_HOME persona while keeping
    ...
    # Pointer to the fetih-agent skill + docs for user questions about FETIH itself.
    stable_parts.append(FETIH_AGENT_HELP_GUIDANCE)
    ...
    # FETIH_KANBAN_TASK env var). Normal chat sessions never see
    # this block.
    ...
    if not agent.skip_context_files:
        ...
        # mode).  The gateway process runs from the fetih-agent install
...
def build_system_prompt(agent: Any, system_message: Optional[str] = None) -> str:
    ...
    one cached block — FETIH never rebuilds or reinjects parts of it
