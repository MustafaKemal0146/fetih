"""Language Server Protocol (LSP) integration for FETIH.

FETIH runs full language servers (pyright, gopls, rust-analyzer,
...
def get_service() -> Optional[LSPService]:
    ...
    with _service_lock:
        ...
        if not _atexit_registered:
            ...
            # ``fetih chat`` exit would leak pyright processes that
