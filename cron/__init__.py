"""
Cron job scheduling system for FETIH.
...
Cron jobs are executed automatically by the gateway daemon:
    fetih gateway install    # Install as a user service
    sudo fetih gateway install --system  # Linux servers: boot-time system service
    fetih gateway            # Or run in foreground
