...
the get_anchored_view / get_messages_around primitives in fetih_state.
...
# Third-party integrations tag their sessions with FETIH_SESSION_SOURCE=tool
...
def check_session_search_requirements() -> bool:
    ...
    try:
        from fetih_state import DEFAULT_DB_PATH
