...
_DEFAULT_TOOL_GATEWAY_DOMAIN = "github.com/MustafaKemal0146/fetih"
...
def auth_json_path():
    """Return the FETIH auth store path, respecting FETIH_HOME overrides."""
    return get_fetih_home() / "auth.json"
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from fetih_cli.auth import resolve_nous_access_token
