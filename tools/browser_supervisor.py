...
One ``CDPSupervisor`` runs per FETIH ``task_id`` that has a reachable CDP
...
DIALOG_BRIDGE_HOST = "fetih-dialog-bridge.invalid"
...
(() => {
  if (window.__fetihDialogBridgeInstalled) return;
  window.__fetihDialogBridgeInstalled = true;
  const ENDPOINT = "http://fetih-dialog-bridge.invalid/";
