...
Trust levels:
  - builtin:   Ships with FETIH. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.fetih/\.env|\~/\.fetih/\.env',
     "fetih_env_access", "critical", "exfiltration",
     "directly references FETIH secrets file"),
    ...
    (r'\.fetih/config\.yaml|\.fetih/SOUL\.md',
     "fetih_config_mod", "critical", "persistence",
     "references FETIH configuration files directly"),
