...
export function isPrintableAscii(s, threshold = 0.85) {
    if (!s.length)
        return false;
...
export function extractStrings(buf, minLen = 4) {
    const results = [];
    let current = '';
