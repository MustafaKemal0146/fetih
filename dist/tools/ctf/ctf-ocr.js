...
async function runOcr(filePath, language = 'eng+tur') {
...
async function runQrDecode(filePath) {
...
// ─── Tool Tanımı ─────────────────────────────────────────────────────────────
export const ctfOcrTool = {
    name: 'ctf_ocr',
    description: 'CTF OCR + QR/Barcode okuma. Eylemler: ocr (tesseract → VLM fallback), ' +
