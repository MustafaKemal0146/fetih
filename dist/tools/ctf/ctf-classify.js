...
// ─── Tool Tanımı ─────────────────────────────────────────────────────────────
export const ctfClassifyTool = {
    name: 'ctf_classify',
    description: 'CTF challenge metnini analiz et, kategori tahmin et ve önerilen tool zincirini dön. ' +
    ...
    async execute(input) {
        ...
        if (!text)
            return { output: 'text gerekli', isError: true };
