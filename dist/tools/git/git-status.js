...
export const gitStatusTool = {
    name: 'git_status',
    description: 'Git deposunun kısa durumunu gösterir (dal + izlenen dosyalar). Salt okunur; shell yerine bunu kullan.',
    inputSchema: {
        type: 'object',
        properties: {
            path: {
                type: 'string',
                description: 'İsteğe bağlı alt yol (cwd’ye göre); yalnızca bu alt ağaç için durum özeti.',
            },
        },
        required: [],
    },
