"""FETIH CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.fetih/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "FETIH"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ FETIH "       # Response box header label
...
.. code-block:: python
    ...
    from fetih_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "FETIH"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.fetih/skins/
...
Drop a YAML file in ``~/.fetih/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces FETIH_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces FETIH_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "FETIH — crimson & bronze",
        "colors": {
        ...
        "branding": {
            "agent_name": "FETIH",
            "welcome": "Welcome to FETIH! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ FETIH ",
            "prompt_symbol": "❯",
...
[dim #7A3511]⠀⠀⠀⠀⠀⠀⠀tail flame lit⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "red": {
        "name": "red",
        "description": "Kırmızı tema — parlak kırmızı tonlar",
        "colors": {
            ...
            "status_bar_bg":       "#2A0A0A",
            "status_bar_text":     "#FFE5E5",
            "status_bar_strong":   "#FF6B6B",
            "status_bar_dim":      "#7A3A3A",
            "status_bar_good":     "#66CC66",
            "status_bar_warn":     "#FFAA44",
            "status_bar_bad":      "#FF4444",
            "status_bar_critical": "#FF2222",
            "session_label":       "#FF6B6B",
            "session_border":      "#CC3333",
        },
        "branding": {
            "agent_name": "FETIH",
            "welcome": "FETIH hazır! Mesajını yaz veya /help komutlarını gör.",
            "goodbye": "Görüşürüz! ⚕",
            "response_label": " ⚕ FETIH ",
            "prompt_symbol": "❯",
    ...
    "green": {
        "name": "green",
        "description": "Yeşil tema — zümrüt ve orman tonları",
        "colors": {
            "banner_border":       "#1A6B3A",
            "banner_title":        "#66CC88",
            "banner_accent":       "#2ECC71",
            "banner_dim":          "#27AE60",
            "banner_text":         "#E8F8E8",
            "ui_accent":           "#2ECC71",
            "ui_label":            "#66CC88",
            ...
            "prompt":              "#E8F8E8",
            "input_rule":          "#1A6B3A",
            "response_border":     "#66CC88",
            "status_bar_bg":       "#0A2A14",
            "status_bar_text":     "#E8F8E8",
            "status_bar_strong":   "#66CC88",
            "status_bar_dim":      "#3A7A50",
            "status_bar_good":     "#2ECC71",
            "status_bar_warn":     "#F4D03F",
            "status_bar_bad":      "#EF5350",
            "status_bar_critical": "#FF2222",
            "session_label":       "#66CC88",
            "session_border":      "#27AE60",
        },
        "branding": {
            "agent_name": "FETIH",
            "welcome": "FETIH hazır! Mesajını yaz veya /help komutlarını gör.",
    ...
    "gold": {
        "name": "gold",
        "description": "Altın tema — amber ve sarı tonlar",
        "colors": {
            "banner_border":       "#8B6914",
            "banner_title":        "#FFD700",
            "banner_accent":       "#F4D03F",
            "banner_dim":          "#D4A017",
            "banner_text":         "#FEF9E7",
            "ui_accent":           "#F4D03F",
            "ui_label":            "#FFD700",
            ...
            "status_bar_bg":       "#2A2000",
            "status_bar_text":     "#FEF9E7",
            "status_bar_strong":   "#FFD700",
            "status_bar_dim":      "#7A6020",
            "status_bar_good":     "#66CC66",
            "status_bar_warn":     "#F4D03F",
            "status_bar_bad":      "#EF5350",
            "status_bar_critical": "#FF2222",
            "session_label":       "#FFD700",
            "session_border":      "#D4A017",
        },
        "branding": {
            "agent_name": "FETIH",
            "welcome": "FETIH hazır! Mesajını yaz veya /help komutlarını gör.",
    ...
    "heaven": {
        "name": "heaven",
        "description": "Cennet teması — buz mavisi ve açık mavi tonlar",
        "colors": {
            "banner_border":       "#1A4A8B",
            "banner_title":        "#87CEEB",
            "banner_accent":       "#5DADE2",
            "banner_dim":          "#2E86C1",
            "banner_text":         "#EBF5FB",
            "ui_accent":           "#5DADE2",
            "ui_label":            "#87CEEB",
            ...
            "status_bar_bg":       "#0A1A2A",
            "status_bar_text":     "#EBF5FB",
            "status_bar_strong":   "#87CEEB",
            "status_bar_dim":      "#3A6080",
            "status_bar_good":     "#66CC66",
            "status_bar_warn":     "#F4D03F",
            "status_bar_bad":      "#EF5350",
            "status_bar_critical": "#FF2222",
            "session_label":       "#87CEEB",
            "session_border":      "#2E86C1",
        },
        "branding": {
            "agent_name": "FETIH",
            "welcome": "FETIH hazır! Mesajını yaz veya /help komutlarını gör.",
