...
Used by ``fetih kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``fetih_cli/goals.py`` — same aux
...
_SYSTEM_PROMPT = """You are the Kanban triage specifier for the FETIH board.
...
def _profile_author() -> str:
    """Mirror of ``fetih_cli.kanban._profile_author``. Kept local to
