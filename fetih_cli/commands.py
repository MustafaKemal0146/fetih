...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("rollback", "List or restore filesystem checkpoints", "Session",
               args_hint="[number]"),
    CommandDef("snapshot", "Create or restore state snapshots of FETIH config/state", "Session",
    ...
    CommandDef("steer", "Inject a message after the next tool call without interrupting", "Session",
               args_hint="<prompt>"),
    CommandDef("goal", "Set a standing goal FETIH works on across turns until achieved", "Session",
    ...
    CommandDef("busy", "Control what Enter does while FETIH is working", "Configuration",
    ...
    CommandDef("reload-mcp", "Reload MCP servers from config", "Tools & Skills",
               aliases=("reload_mcp",)),
    CommandDef("reload-skills", "Re-scan ~/.fetih/skills/ for newly installed or removed skills",
    ...
    CommandDef("validate-skills",
               "Tum skill'leri tara: YAML, MITRE ID, trigger cakismalari, ceviri hatalari",
               "Tools & Skills", cli_only=True,
               aliases=("skill-check",),
               args_hint="[--category name] [--fix] [--report] [--json]",
               subcommands=("malware-analysis", "cloud-security", "threat-hunting",
                            "web-application-security", "network-security", "incident-response")),
    CommandDef("report",
               "Otomatik pentest raporu olustur (executive summary, CVSS, MITRE, NIST CSF)",
               "Tools & Skills", cli_only=True,
    ...
    CommandDef("auto-solve",
               "CTF challenge'ini otomatik coz: siniflandir -> coz -> flag topla",
               "Tools & Skills", cli_only=True,
    ...
    CommandDef("computer-use",
               "Masaustu kontrolunu ac/kapat/durum (varsayilan: KAPALI)",
               "Tools & Skills", cli_only=True,
               aliases=("desktop", "cu"),
               args_hint="[on|off|status]",
               subcommands=("on", "off", "status")),
    CommandDef("hint",
               "CTF ipucu sistemi: seviye 1 (nudge) -> 2 (direction) -> 3 (solution)",
               "Tools & Skills", cli_only=True,
               aliases=("ipucu", "clue"),
               args_hint="[more|solution|status|reset]",
               subcommands=("more", "solution", "status", "reset")),
    CommandDef("learnings",
               "Otomatik ogrenme veritabani: kaydedilmis teknikler, hatalar, cozumler",
               "Tools & Skills", cli_only=True,
               aliases=("learned", "learning"),
               args_hint="[list|search <query>|stats]",
               subcommands=("list", "search", "stats")),
    CommandDef("dashboard",
               "FETIH durum panosu: oturum, tool, ogrenme ve hata istatistikleri",
               "Info", cli_only=True,
    ...
    CommandDef("update", "FETIH ve skill'leri en son surume guncelle", "Info",
               aliases=("upgrade",),
