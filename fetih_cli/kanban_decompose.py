...
Invoked by ``fetih kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the FETIH board.
...
def _profile_author() -> str:
    """Mirror of ``fetih_cli.kanban._profile_author``."""
    return (
        os.environ.get("FETIH_PROFILE")
