...
Usage:
    fetih pairing list              # Show all pending + approved users
    fetih pairing approve <platform> <code>  # Approve a pairing code
    fetih pairing revoke <platform> <user_id> # Revoke user access
    fetih pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle fetih pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: fetih pairing {list|approve|revoke|clear-pending}")
        print("Run 'fetih pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.fetih/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'fetih pairing list' to see pending codes.\n")
