"""
Skills configuration for FETIH.
`fetih skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.fetih/config.yaml under:
...
from fetih_cli.config import cfg_get, load_config, save_config
from fetih_cli.colors import Colors, color
from fetih_cli.platforms import PLATFORMS as _PLATFORMS
