...
def cron_list(show_all: bool = False):
    ...
    if not jobs:
        ...
        print(color("Create one with 'fetih cron create ...' or the /cron command in chat.", Colors.DIM))
        return
    ...
    if not find_gateway_pids():
        ...
        print(color("     Start it with: fetih gateway install", Colors.DIM))
        print(color("                    sudo fetih gateway install --system  # Linux servers", Colors.DIM))
        print()
...
def cron_status():
    ...
    if pids:
        ...
        print("    fetih gateway install    # Install as a user service")
        print("    sudo fetih gateway install --system  # Linux servers: boot-time system service")
        print("    fetih gateway            # Or run in foreground")
...
def cron_command(args):
    ...
    print("Usage: fetih cron [list|create|edit|pause|resume|run|remove|status|tick]")
    sys.exit(1)
