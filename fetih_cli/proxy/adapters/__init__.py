...
from fetih_cli.proxy.adapters.base import UpstreamAdapter
from fetih_cli.proxy.adapters.nous_portal import NousPortalAdapter

# Registry of available adapter classes keyed by provider name as used on
# the ``fetih proxy start --provider <name>`` CLI flag.
