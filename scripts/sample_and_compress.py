...
DEFAULT_DATASETS = [
    "FETIH/swe-terminus-agent-glm-kimi-minimax",
    "MustafaKemal0146/fetih-megascience-sft1",
    "FETIH/FETIH-Agent-Thinking-GLM-4.7-SFT2",
    "FETIH/FETIH-Agent-Thinking-GLM-4.7-SFT1",
    "FETIH/terminal-tasks-glm-fetih-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "FETIH/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload FETIH/{output_name} {final_output}")
