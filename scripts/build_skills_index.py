#!/usr/bin/env python3
"""Build the FETIH Skills Index — a centralized JSON catalog of all skills.
...
`fetih skills search/install` can use it without hitting the GitHub API.
...
# Ensure FETIH_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building FETIH Skills Index...", flush=True)
