...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^FETIH\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "fetih@github.com/MustafaKemal0146/fetih",
    "fetih-audit@example.com",
    "fetih@habibilabs.dev",
}
