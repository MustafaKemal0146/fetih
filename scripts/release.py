...
VERSION_FILE = REPO_ROOT / "fetih_cli" / "__init__.py"
...
AUTHOR_MAP = {
    ...
    "jake@github.com/MustafaKemal0146/fetih": "simpolism",
    ...
    "teknium@github.com/MustafaKemal0146/fetih": "teknium1",
    ...
    "274096618+fetih-agent-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "shannon@github.com/MustafaKemal0146/fetih": "shannonsands",
    ...
    "fetih@github.com/MustafaKemal0146/fetih": "FETIH",
    ...
    "ben@github.com/MustafaKemal0146/fetih": "benbarclay",
    ...
    "emozilla@github.com/MustafaKemal0146/fetih": "emozilla",
    ...
    "jonny@github.com/MustafaKemal0146/fetih": "jquesnelle",
    "jake@github.com/MustafaKemal0146/fetih": "simpolism",
    ...
    "fetih@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (FETIH_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (FETIH_HOME inject)
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: fetih-eval community link)
    ...
    "clement@github.com/MustafaKemal0146/fetih": "lemassykoi",  # PR #27042 (model-switch probe keyless providers)
    ...
    "vigo@fetih": "hawknewton",  # PR #26294 (bedrock boto3 lazy_deps)
...
def _update_acp_registry_versions(semver: str) -> None:
    ...
    if ACP_REGISTRY_MANIFEST.exists():
        ...
        if "package" in uvx:
            uvx["package"] = f"fetih[acp]=={semver}"
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "fetih@github.com/MustafaKemal0146/fetih"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/MustafaKemal0146/fetih",
    ...
    lines.append(f"# FETIH v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for FETIH. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="FETIH Release Tool")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"FETIH v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"FETIH v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'FETIH v{new_version} ({calver_date})' "
