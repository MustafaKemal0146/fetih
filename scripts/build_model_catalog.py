#!/usr/bin/env python3
"""Build the FETIH Model Catalog — a centralized JSON manifest of curated models.
...
FETIH CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a FETIH release.
...
``https://github.com/MustafaKemal0146/fetih/docs/api/model-catalog.json``
"""
...
# Ensure FETIH_HOME is set for imports that touch it at module level.
os.environ.setdefault("FETIH_HOME", os.path.join(os.path.expanduser("~"), ".fetih"))

from fetih_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "fetih-agent repo",
            "docs": "https://github.com/MustafaKemal0146/fetih/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
