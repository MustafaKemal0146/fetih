...
def _profile_user_agent() -> str:
    """Return a ``fetih-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from fetih_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"fetih-cli/{_ver}"
    except Exception:
        return "fetih-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # fetih-cli UA so the catalog endpoint is reachable.
