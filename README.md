...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Version-3.7.2-purple?style=flat-square"/>
...
npm install -g ./release/seth-3.7.2.tgz
```

İsteğe bağlı doğrulama:

```bash
sha256sum -c ./release/seth-3.7.2.tgz.sha256
```
