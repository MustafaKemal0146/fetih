<p align="center">
  <img src="logo.jpg" alt="FETİH" width="480"/>
</p>

<h1 align="center">FETİH</h1>
...
| `/paylaş` | Konuşmayı `~/.fetih/exports/` klasörüne aktar |
...
| Dosya | Açıklama |
|-------|----------|
| `FETİH.md` | FETİH'e özel proje talimatları |
| `CLAUDE.md` | Claude uyum katmanı |
| `AGENTS.md` | Ajan direktifleri |
| `.fetih/instructions.md` | Gizli proje talimatları |
