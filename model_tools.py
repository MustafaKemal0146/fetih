...
#   - cli.py, fetih_cli/*      -> inline on startup (no event loop)
...
def get_tool_definitions(
    ...
    if quiet_mode:
        try:
            from fetih_cli.config import get_config_path
...
def _compute_tool_definitions(
    ...
    # This ensures that even if a composite toolset (like fetih-cli)
