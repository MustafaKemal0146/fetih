...
This skill is designed for the FETIH agent. It uses FETIH tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other FETIH skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.fetih/plans/` | `skill_view("plan")` |
