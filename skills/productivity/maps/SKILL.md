...
Script path: `~/.fetih/skills/maps/scripts/maps_client.py`

## Commands

```bash
MAPS=~/.fetih/skills/maps/scripts/maps_client.py
```
...
```bash
python3 ~/.fetih/skills/maps/scripts/maps_client.py search "Statue of Liberty"
