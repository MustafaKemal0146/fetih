...
```python
import sys
sys.path.insert(0, "/home/teknium/.fetih/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.fetih/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — FETIH installs package this)
