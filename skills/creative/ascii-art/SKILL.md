...
```bash
python3 -m pyfiglet "FETIH" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=FETIH&font=Slant" | boxes -d stone
```
