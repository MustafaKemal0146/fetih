...
description: Open Source Intelligence (OSINT) gathering is the first active phase of a red team engagement, where operators collect publicly available information about the target organization to identify
  attack s
tags:
- red-team
- exploitation
...
- conducting yaparken security assessments that involve performing open source intelligence gathering
...
### Aşama 1: Domain and Network Reconnaissance
...
### Aşama 2: Personnel and Social Intelligence
...
### Aşama 3: Credential and Data Leak Discovery
...
4. Ara: exposed configuration files and backups
5. Check for leaked internal documents via Google dorking

### Aşama 4: Technology Stack Identification
...
| SubBul:er | Passive subdomain discovery | Open Source |
