...
Control the user's Spotify account via the FETIH Spotify toolset (7 tools). Setup guide: https://github.com/MustafaKemal0146/fetih/docs/user-guide/features/spotify
...
**`401 Unauthorized` after a retry** — refresh token revoked. Tell the user to run `fetih auth spotify` again.
