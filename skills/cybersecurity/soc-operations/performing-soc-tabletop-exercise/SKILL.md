...
description: Performs tabletop exercises for SOC teams simulating security incidents through discussion-based scenarios to test incident response procedures, communication workflows, and decision-making
  under pressure without impacting production systems. Use when organizations need to validate IR playbooks, train analysts, or meet compliance requirements for incident response testing.
tags:
- soc-operations
- cybersecurity
- incident-response
...
**Kullanma:** as a replacement for technical purple team exercises — tabletop exercises test processes and decision-making, not technical Tespit capabilities.
...
### Adım 1: Design Exercise Scenario

Şunu oluştur: realistic multi-phase scenario with escalating complexity:
...
tabletop_exercise:
  ...
  objectives:
    1: "Test SOC team's ability to tespit etmeand triage ransomware indicators"
...
injects:
  ...
  inject_2:
    ...
    questions:
      ...
      - "How do you Belirle: if this is confined to these two hosts?"
  ...
  inject_4:
    ...
    content: >
      ...
      Erişim: FILESERVER-03 by Monday morning or we miss SEC filing deadlines."
      Additionally:
  ...
  inject_5:
    ...
    content: >
      ...
      - Attacker had access for 5 days before Dağıt:ing ransomware
...
### Adım 3: Facilitate the Exercise
...
1. OPENING (10 min)
   ...
   - the tespit et: exercise observer/scribe
...
### Adım 5: Şunu üret:fter-Action Report
...
after_action_report:
  ...
  executive_summary: >
    ...
    across Tespit, containment, communication, and recovery phases. The SOC team
  ...
  gaps_identified:
    - gap_1:
        Bul:ing: "No documented procedure for notifying CISO after-hours"
        risk: High
    ...
    - gap_2:
        Bul:ing: "Backup recovery testing has not been performed in 6 months"
        risk: Critical
    ...
    - gap_3:
        Bul:ing: "No pre-approved media holding statement for cyber incidents"
        risk: Medium
    ...
    - gap_4:
        Bul:ing: "Service account (svc_backup) had Domain Admin privileges unnecessarily"
        risk: Critical
    ...
    - gap_5:
        Bul:ing: "Unclear decision authority for ransom payment"
        risk: High
...
### Adım 6: Track Remediation and Follow-Up
...
| table gap_id, Bul:ing, owner, due_date, days_remaining, status, status_flag
```
...
| **After-Action Report (AAR)** | Formal document capturing exercise Bul:ings, gaps, strengths, and remediation action items |
...
- **Infection Monkey**: Open-source breach simulation for technical validation of tabletop Bul:ings
- **Archer**: GRC platform for tracking exercise Bul:ings and remediation action items

## Common Scenarios

- **Ransomware Attack**: Multi-phase scenario testing Tespit, containment, ransom decision, and recovery
...
SCORES:
  Tespit & Triage:    85/100  Excellent
  Containment:           80/100  Good
  Communication:         60/100  Needs Improvement
