...
description: Performs User and Entity Behavior Analytics (UEBA) to tespit etmeanomalous user activities including impossible travel, unusual access patterns, privilege abuse, and insider threats using SIEM-based
  behavioral baselines and statistical analysis. Use when SOC teams need to identify compromised accounts or insider threats through deviation from established behavioral norms.
tags:
- soc-operations
- baseline
- soc
...
Use bu skill when:
- SOC teams need to tespit etmecompromised accounts through abnormal authentication patterns
- Insider threat programs require behavioral monitoring beyond rule-based Tespit
- Impossible travel or geographic anomalies indicate credential compromise
- Privileged account monitoring requires baseline deviation Tespit

**Kullanma:** as the sole basis for disciplinary action — UEBA Bul:ings are indicators requiring investigation, not proof of malicious intent.
...
- GeoIP database (MaxMind GeoLite2) for location-based anomaly Tespit
...
### Adım 1: Build User Authentication Baselines
...
### Adım 2: tespit etmeImpossible Travel
...
### Adım 3: tespit etmeAnomalous Login Timing
...
### Adım 4: tespit etmeUnusual Data Access Patterns
...
### Adım 5: tespit etmePrivilege Abuse Patterns
...
### Adım 6: Generate Risk Score and Prioritize Investigation
...
| Term | Definition |
|------|-----------|
| **UEBA** | User and Entity Behavior Analytics — behavioral analysis Tespit etme anomalies against established baselines |
...
- **Splunk UBA**: Dedicated User Behavior Analytics module integrating with Splunk ES for ML-driven anomaly Tespit
...
- **Securonix**: Cloud-native SIEM/UEBA with pre-built behavioral models for insider threat Tespit
...
- **Shared Account Tespit**: Service account logging in from multiple geographies simultaneously
