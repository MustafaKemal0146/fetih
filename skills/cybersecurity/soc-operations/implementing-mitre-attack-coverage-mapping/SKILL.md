...
description: Implement MITRE ATT&CK coverage mapping to identify Tespit gaps, prioritize rule development, and measure SOC Tespit maturity against adversary techniques.
tags:
- soc-operations
- Tespit-coverage
- soc
...
MITRE ATT&CK coverage mapping gives SOC teams a structured, adversary-centric lens to evaluate Tespit capabilities. Enterprise SIEMs on average have Tespit coverage for only 21% of ATT&CK techniques (2025 CardinalOps report), with 13% of existing rules being non-functional due to misconfigured data sources. Systematic coverage mapping identifies gaps, prioritizes rule development, and tracks Tespit maturity over time. ATT&CK v18.1 (December 2025) is the latest version.


## Ne Zaman Kullanılır

- Dağıt:ing yaparken or configuring implementing mitre attack coverage mapping capabilities in your environment
...
- Erişim: MITRE ATT&CK Navigator (https://mitre-attack.github.io/attack-navigator/)
- Inventory of all active SIEM Tespit rules
- MITRE ATT&CK technique mapping for each Tespit rule
...
### Adım 1: Export Current Detection Rules
...
### Adım 2: Şunu inşa et: Coverage Matrix
...
```json
{
    ...
    "description": "Current Tespit coverage mapping",
    "techniques": [
        {
            "techniqueID": "T1110",
            "tactic": "credential-access",
            "color": "#00ff00",
            "comment": "2 active rules - Brute Force Tespit via EventCode 4625",
            "score": 75,
            "metadata": [
        ...
        },
        {
            ...
            "color": "#ff0000",
            "comment": "NO tespit etme (ION) - Requires Sysmon EventCode 8/10",
            "score": 0
        }
    ],
    "gradient": {
...
### Adım 3: Score Each Technique

| Score | Color | Meaning | Criteria |
|---|---|---|---|
| 0 | Red | No Tespit | No rules, missing data sources |
...
- [CardinalOps - SIEM Detection Coverage Report 2025](https://www.helpnetsecurity.com/2025/06/09/siem-Tespit-coverage/)
