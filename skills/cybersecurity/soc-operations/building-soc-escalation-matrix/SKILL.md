...
- Documents initial Bul:ings in ticketing system
...
- Develops Tespit rules and playbooks
...
| Examples | Vulnerability scan Bul:ings, expired certificates, policy exceptions |
