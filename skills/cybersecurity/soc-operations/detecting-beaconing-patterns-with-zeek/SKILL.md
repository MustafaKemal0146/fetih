---
name: Tespit etme-beaconing-patterns-with-zeek
description: Performs statistical analysis of Zeek conn.log connection intervals to tespit etmeC2 beaconing patterns. Uses the ZAT library to load Zeek logs into Pandas DataFrames, calculates inter-arrival
  time standard deviation, and flags periodic connections with low jitter. Use hunting yaparken for command-and-control callbacks in network data.
tags:
- soc-operations
- security-operations
- fetih
...
- investigating yaparken security incidents that require Tespit etme beaconing patterns with zeek
