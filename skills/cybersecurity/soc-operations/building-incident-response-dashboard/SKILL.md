...
description: Builds real-time incident response dashboards in Splunk, Elastic, or Grafana to provide SOC analysts and leadership with situational awareness during active incidents, tracking affected systems,
  containment status, IOC spread, and response timeline. Use when IR teams need unified visibility during incident coordination and post-incident reporting.
tags:
- metrics
- soc-operations
- cybersecurity
...
**Kullanma:** for day-to-day SOC monitoring dashboards (use Incident Review instead) — IR dashboards are designed for active incident coordination and management reporting.
...
### Adım 1: Design Active Incident Dashboard Layout
...
### Adım 2: Build Real-Time Affected Systems Panel
...
### Adım 3: Build IOC Tracking Panel
...
### Adım 4: Build Response Timeline Panel
...
2024-03-15 14:00,Tespit,Alert triggered - Cobalt Strike beacon Detected,splunk_es,Notable event NE-2024-08921
...
2024-03-15 14:35,containment,C2 domain blocked on firewall,analyst_msmith,Palo Alto rule Dağıtılmış
...
### Adım 5: Build SOC Operations Dashboard
...
### Adım 6: Build Executive Briefing Dashboard

Şunu oluştur: high-level dashboard for leadership during major incidents:
...
### Adım 7: Automate Dashboard Updates
...
- **Compliance Audit**: Dashboard demonstrating Tespit coverage, response SLA compliance, and incident closure metrics
