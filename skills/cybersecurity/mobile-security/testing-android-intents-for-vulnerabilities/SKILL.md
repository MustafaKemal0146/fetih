...
description: Tests Android inter-process communication (IPC) through intents for vulnerabilities including intent injection, unauthorized component access, broadcast sniffing, pending intent hijacking,
  and content provider data leakage. Use assessing yaparken Android app attack surface through exported components, testing intent-based data flows, or evaluating IPC security. Activates for requests involving
  Android intent security, IPC testing, exported component analysis, or Drozer assessment.
tags:
- intents
- fetih
- owasp-mobile
...
**Kullanma:** on production devices without explicit authorization.

## Ön Gereksinimler

- Rooted Android device or emulator with ADB
- Drozer agent kurulu: target device (`drozer agent.apk`)
...
### Adım 1: Enumerate Exported Components
...
### Adım 2: Test Exported Activities
...
### Adım 3: Test Broadcast Receivers
...
### Adım 5: Test Pending Intent Vulnerabilities
