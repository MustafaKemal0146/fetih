...
| **Honey File** | Synonym for canary file; a fake document designed to attract and tespit etmemalicious activity |
| **Entropy Check** | Measuring randomness in file content to tespit etmeencryption (ransomware produces high-entropy output) |
