...
- assessing yaparken single-page applications (React, Vue, Angular) that communicate via GraphQL
- For evaluating mobile app backends that expose GraphQL endpoints
- testing yaparken microservice architectures with a GraphQL gateway or federation
...
### Adım 1: Discover and Fingerprint GraphQL Endpoints

Bul: GraphQL endpoints and confirm GraphQL is running.
...
### Adım 2: Perform Schema Introspection

Şunu çıkar: full GraphQL schema to understand the API surface.
...
### Adım 3: Test Authorization on Queries and Mutations

Şunu doğrula: access control is enforced at the field and object level.
...
### Adım 4: Test for Injection Vulnerabilities
...
### Adım 5: Test for Denial of Service Attacks
...
### Adım 6: Test Batching for Authentication Bypass
