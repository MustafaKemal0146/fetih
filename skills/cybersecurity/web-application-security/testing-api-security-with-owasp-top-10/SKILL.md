...
- assessing yaparken REST, GraphQL, or gRPC APIs for security vulnerabilities
- Before Dağıt:ing new API endpoints to production environments
- reviewing yaparken API security posture against the OWASP API Security Top 10 (2023)
...
### Adım 1: Discover and Map API Endpoints
...
### Adım 2: Test API1 - Broken Object Level Authorization (BOLA)
...
### Adım 3: Test API2 - Broken Authentication
...
### Adım 4: Test API3 - Broken Object Property Level Authorization
...
### Adım 5: Test API4/API6 - Rate Limiting and Unrestricted Erişim: Sensitive Flows
...
### Adım 6: Test API5 - Broken Function Level Authorization
...
### Adım 7: Test API7-API10 - SSRF, Misconfiguration, Inventory, and Unsafe Consumption
...
### Critical Bul:ing: BOLA on Orders API
