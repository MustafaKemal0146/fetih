...
| **Corporate** | Medium | Employee workstations, printers | Controlled Erişim: internal resources |
...
### Adım 1: Map Traffic Flows and Define Zones
...
### Adım 2: Configure VLANs on Switches
...
### Adım 3: Configure Firewall Zone Policies
...
### Adım 4: Implement Inter-VLAN Routing ACLs

Ek layer 3 filtering on the router/L3 switch:
