...
description: Dağıt: and query Arkime (formerly Moloch) for full packet capture network traffic analysis. Uses the Arkime API v3 to search sessions, download PCAPs, analyze connection patterns, tespit etmebeaconing
  behavior, and identify suspicious network flows. Monitors DNS queries, HTTP traffic, and TLS certificate anomalies across captured traffic.
tags:
- cybersecurity
- analysis
- traffic
...
- Dağıt:ing yaparken or configuring implementing network traffic analysis with arkime capabilities in your environment
...
3. Run the agent to query Arkime sessions and analyze traffic:
   ...
   - tespit etmeC2 beaconing via connection interval analysis
