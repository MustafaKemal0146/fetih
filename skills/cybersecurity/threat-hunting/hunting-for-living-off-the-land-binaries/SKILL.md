...
description: Proactively hunt for adversary abuse of legitimate system binaries (LOLBins) to execute malicious payloads while evading Tespit.
tags:
- siem
- threat-hunting
- lolbins
...
- investigating yaparken fileless malware campaigns that bypass traditional AV
- During proactive threat hunts targeting defense evasion techniques
- EDR yaparken: alerts fire on legitimate binaries executing unusual child processes
- threat intelligence sonrasında reports indicate LOLBin abuse in active campaigns
- During red team/purple team exercises validating Tespit coverage for T1218

## Ön Gereksinimler

- Erişim: EDR telemetry (CrowdStrike, Microsoft Defender for Endpoint, SentinelOne)
...
7. **Document and Report**: Record Bul:ings, update Tespit rules, and create IOC lists for identified malicious LOLBin usage.
...
LOLBins Araştır:d: [List of binaries]
Time Range: [Start] - [End]
Data Sources: [EDR, Sysmon, SIEM]
Bul:ings:
  - [Bul:ing 1 with evidence]
  - [Bul:ing 2 with evidence]
