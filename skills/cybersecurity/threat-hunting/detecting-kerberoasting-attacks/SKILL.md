---
name: Tespit etme-kerberoasting-attacks
description: tespit etmeKerberoasting attacks by monitoring for anomalous Kerberos TGS requests targeting service accounts with SPNs for offline password cracking.
tags:
- threat-hunting
- kerberoasting
- kerberos
...
# Detection Kerberoasting Attacks


## Ne Zaman Kullanılır

- Proaktif olarak şu göstergeleri ararken: Tespit etme kerberoasting attacks in the environment
