---
name: Tespit etme-privilege-escalation-attempts
description: tespit etmeprivilege escalation attempts including token manipulation, UAC bypass, unquoted service paths, kernel exploits, and sudo/doas abuse across Windows and Linux.
tags:
- threat-hunting
- uac-bypass
- proactive-detection
...
- Proaktif olarak şu göstergeleri ararken: Tespit etme privilege escalation attempts in the environment
