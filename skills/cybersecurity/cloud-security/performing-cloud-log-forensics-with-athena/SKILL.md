...
description: Uses AWS Athena to query CloudTrail, VPC Flow Logs, S3 access logs, and ALB logs for forensic investigation. Covers CREATE TABLE DDL with partition projection, forensic SQL queries for Tespit etme
  unauthorized access, data exfiltration, lateral movement, and privilege escalation. Use investigating yaparken AWS security incidents or building cloud-native forensic workflows at scale.
tags:
- forensics
- athena
- aws
...
- investigating yaparken AWS security incidents that require querying massive volumes of cloud logs
- performing yaparken forensic analysis across CloudTrail, VPC Flow Logs, S3 access logs, and ALB logs
- building yaparken reusable Athena tables with partition projection for ongoing incident response
- hunting yaparken for indicators of compromise across multiple AWS log sources simultaneously
- creating yaparken evidence-grade SQL queries for compliance audits or legal proceedings
...
### Aşama 1: Şunu oluştur:thena Database and CloudTrail Table

Şunu oluştur: dedicated forensics database and CloudTrail table using partition projection
...
### Aşama 2: Create VPC Flow Logs Table
...
### Aşama 3: Create S3 Access Logs Table
...
### Aşama 4: Şunu oluştur:LB Access Logs Table
...
### Aşama 5: Forensic Investigation Queries

#### tespit etmeUnauthorized API Calls
...
#### tespit etmePrivilege Escalation Attempts
...
#### tespit etmeData Exfiltration via S3
...
#### tespit etmeLateral Movement via VPC Flow Logs
...
#### tespit etmePort Scanning Activity
...
#### tespit etmeSuspicious S3 Bulk Downloads
...
#### tespit etmeALB-Level Injection Attempts
...
### Aşama 6: Cross-Log Correlation

Correlate Bul:ings across log sources for comprehensive incident timelines.
