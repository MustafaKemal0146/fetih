---
name: Tespit etme-azure-service-principal-abuse
description: tespit etmeand Araştır: Azure service principal abuse including privilege escalation, credential compromise, admin consent bypass, and unauthorized enumeration in Microsoft Entra ID environments.
tags:
- splunk
- azure
- sentinel
...
- investigating yaparken security incidents that require Tespit etme azure service principal abuse
...
- Erişim: Azure AD Audit Logs and Sign-in Logs
- Microsoft Sentinel or Splunk for SIEM-based Tespit
...
### 3. Service Principal Enumeration Tespit
...
### Adım 1: Identify compromised service principal
...
### Adım 2: Review service principal role assignments
...
### Adım 3: Check application ownership
...
### Adım 4: Review sign-in activity
...
Şunu oluştur:nalytics rules for:
...
- SplunkDetect Azure AD Service Principal Abuse
