...
- conducting yaparken security assessments that involve performing graphql depth limit attack
...
class GraphQLDepthTester:
    ...
    def generate_nested_query(self, depth: int, field_a: str = "posts",
        ...
        """Şunu üret: recursively nested GraphQL query to a specified depth."""
        query = "{ users { "
    ...
    def generate_alias_query(self, count: int, inner_query: str) -> str:
        """Şunu üret: query with multiple aliases."""
        aliases = []
    ...
    def generate_report(self) -> dict:
        """Şunu üret: summary report of all tests."""
