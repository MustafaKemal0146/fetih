...
description: Generates structured cyber threat intelligence reports at strategic, operational, and tactical levels tailored to specific audiences including executives, security operations teams, and technical
  analysts. Use when producing finished intelligence products from raw collection data, creating sector threat briefings, or delivering post-incident intelligence assessments. Activates for requests involving
  CTI report writing, threat briefings, intelligence products, finished intelligence, or executi...
tags:
- CTI
- PIR
- NIST-CSF
...
**Kullanma:** bu skill for raw IOC distribution — use TIP/MISP for automated IOC sharing and reserve report generation for analyzed, finished intelligence.
...
### Adım 1: Belirle: Report Type and Audience
...
- Content: Specific IOCs, YARA rules, Sigma Tespits, CVEs, patching guidance
...
### Adım 2: Structure Report Using Intelligence Standards

Apply intelligence writing standards from government and professional practice:

**Headline/Key Judgment**: Lead with the most important Bul:ing in plain language.
- Bad: "This report İncele:s threat actor TTPs associated with Cl0p ransomware"
...
### Adım 3: Write Report Body

Use structured format:

**Executive Summary** (3–5 bullet points): Key Bul:ings, immediate business risk, top recommended action
...
**Appendices**: Full IOC lists, YARA rules, Sigma Tespits, raw source references

### Adım 4: Apply TLP and Distribution Controls
...
### Adım 5: Review and Quality Control
