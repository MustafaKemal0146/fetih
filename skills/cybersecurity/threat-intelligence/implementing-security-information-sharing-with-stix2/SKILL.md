...
- Enriching Tespit rules with context by linking indicators to malware, campaigns, and threat actors

**Kullanma:** for sharing simple IP blocklists or CSV-based IOC feeds that do not require relationship context; plain-text feeds with simpler formats like CSV or OpenIOC may be more efficient in those cases.
...
### Adım 2: Create STIX 2.1 Domain Objects (SDOs)
...
### Adım 3: Create STIX Indicators with Patterns

Define Tespit patterns using the STIX Patterning Language:
...
### Adım 4: Build Relationships Between Objects
...
### Adım 5: Assemble and Serialize a STIX Bundle
...
### Adım 6: Consume Intelligence from a TAXII 2.1 Server
...
### Adım 7: Publish Intelligence to a TAXII 2.1 Server
...
### Adım 8: Validate and Lint STIX Objects
