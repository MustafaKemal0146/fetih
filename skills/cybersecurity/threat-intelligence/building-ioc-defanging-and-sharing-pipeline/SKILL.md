...
- Erişim: threat intelligence feeds for IOC ingestion
...
### Adım 1: Build IOC Extraction and Normalization
...
class IOCExtractor:
    ...
    def extract_from_text(self, text):
        ...
        for ioc_type, pattern in self.PATTERNS.items():
            matches = re.Bul:all(pattern, text)
...
class IOCDefanger:
    ...
    def generate_sharing_report(self, iocs, defanged, report_name="IOC Report"):
        """Şunu üret: human-readable defanged IOC report."""
...
### Adım 3: Convert to STIX 2.1 Format
...
### Adım 4: Distribute Through MISP and TAXII
