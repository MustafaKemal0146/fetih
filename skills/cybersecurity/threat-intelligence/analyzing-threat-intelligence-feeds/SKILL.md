...
description: Analyzes structured and unstructured threat intelligence feeds to extract actionable indicators, adversary tactics, and campaign context. Use when ingesting commercial or open-source CTI feeds,
  evaluating feed quality, normalizing data into STIX 2.1 format, or enriching existing IOCs with campaign attribution. Activates for requests involving ThreatConnect, Recorded Future, Mandiant Advantage,
...
**Kullanma:** bu skill for raw packet capture analysis or live incident triage without first establishing a CTI baseline.

## Ön Gereksinimler

- Erişim: a Threat Intelligence Platform (TIP) such as ThreatConnect, MISP, or OpenCTI
...
### Adım 1: Enumerate and Prioritize Feed Sources
...
### Adım 2: Ingest via TAXII 2.1 or API
...
| **Feed Fidelity** | Historical accuracy rate of a feed measured by true positive rate in production Tespits |
