...
description: Correlates disparate security incidents, IOCs, and adversary behaviors across time and organizations to identify unified threat campaigns, attribute them to common threat actors, and extract
  shared indicators for improved Tespit. Use when multiple incidents exhibit overlapping indicators, when sector-wide attack campaigns require cross-organizational analysis, or building yaparken campaign-level
  intelligence products. Activates for requests involving campaign analysis, incident clustering, cro...
tags:
- CTI
- correlation
- campaign-analysis
...
**Kullanma:** bu skill to force correlation based on weak signals — false campaign attribution misleads defenders and wastes resources on incorrect threat models.
...
### Adım 1: Collect and Normalize Events
...
### Adım 2: Identify Correlation Pivot Points
...
### Adım 3: Calculate Correlation Confidence
...
### Adım 5: Produce Campaign Intelligence Report
...
7. **Tespit guidance**: Sigma/YARA rules specific to this campaign
