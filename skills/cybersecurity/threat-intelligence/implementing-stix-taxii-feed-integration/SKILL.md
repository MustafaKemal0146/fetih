...
- Network Erişim: TAXII servers (MITRE ATT&CK TAXII, Anomali STAXX)
...
### Adım 2: Fetch STIX Objects from Collection
...
### Adım 3: Parse STIX 2.1 Objects with stix2 Library
...
### Adım 4: Implement Custom TAXII Consumer
...
### Adım 5: Kur: Local TAXII Server with Medallion
