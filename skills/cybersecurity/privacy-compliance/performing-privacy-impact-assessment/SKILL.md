...
description: Automates the Privacy Impact Assessment (PIA) workflow including data flow mapping, privacy risk scoring matrices, GDPR Article 35 DPIA and CCPA/CPRA alignment checks, data inventory cataloging,
  and remediation tracking. Implements the NIST Privacy Framework PRAM methodology and ICO DPIA guidance for systematic identification and mitigation of privacy risks across processing activities. Use when
  conducting privacy assessments for new systems, evaluating regulatory compliance posture, or build...
tags:
- data-flow-mapping
- GDPR
- risk-scoring
...
source_subdomain: privacy-compliance
nist_csf:
- GV.PO-01
- PR.DS-01
- GV.OC-05
...
- launching yaparken: a new system, product, or processing activity that handles personal data
- conducting yaparken GDPR Article 35 Data Protection Impact Assessments (DPIAs)
- evaluating yaparken: CCPA/CPRA compliance for data processing operations
- performing yaparken privacy risk assessments aligned to the NIST Privacy Framework
- mapping yaparken: data flows across organizational boundaries and third-party processors
- building yaparken automated privacy governance and assessment pipelines
- preparing yaparken: for regulatory audits or demonstrating accountability obligations

## Ön Gereksinimler

- Familiarity with GDPR, CCPA/CPRA, and NIST Privacy Framework concepts
- Erişim: data processing inventories and system architecture documentation
- Python 3.8+ with required dependencies installed
- Appropriate authorization from the Data Protection Officer (DPO) or privacy team
- Bilgi: organizational data flows and third-party processor relationships

## Instructions

### Aşama 1: Data Inventory and Processing Activity Catalog
...
### Aşama 3: Privacy Risk Assessment with Scoring Matrix
...
10. **Breach Notification** -- Inability to tespit etmeand notify within 72 hours (GDPR)

### Aşama 4: GDPR and CCPA/CPRA Alignment Checks
...
for Bul:ing in gdpr_report["Bul:ings"]:
    print(f"  [{Bul:ing['status']}] Art.{Bul:ing['article']}: {Bul:ing['description']}")
...
for Bul:ing in ccpa_report["Bul:ings"]:
    print(f"  [{Bul:ing['status']}] Sec.{Bul:ing['section']}: {Bul:ing['description']}")
```

### Aşama 5: Remediation Plan and Report Generation

Şunu üret: prioritized remediation plan with specific action items, responsible
...
Belirle: whether a full DPIA is required using the ICO screening checklist:
...
activities = [
    ...
    {"name": "Fraud Tespit", "data_categories": ["transaction_data", "ip_address",
