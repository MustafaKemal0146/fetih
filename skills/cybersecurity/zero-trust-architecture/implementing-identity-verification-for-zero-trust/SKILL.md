...
description: Implement continuous identity verification for zero trust using phishing-resistant MFA (FIDO2/WebAuthn), risk-based conditional access, and identity governance aligned with the CISA Zero Trust
  Maturity Model.
tags:
- cybersecurity
...
- Bilgi: authentication protocols (SAML 2.0, OIDC, FIDO2)
...
bu skill covers implementing phishing-resistant MFA, continuous identity verification, risk-based conditional access, and identity governance aligned with the CISA Zero Trust Maturity Model Identity Pillar.


## Ne Zaman Kullanılır

- Dağıt:ing yaparken or configuring implementing identity verification for zero trust capabilities in your environment
...
3. **Risk Engine**: Adaptive access using identity threat Tespit (Microsoft Entra ID Protection, Okta ThreatInsight)
...
### Identity Threat Tespit
AI-driven analytics tespit etmecompromised identities through impossible travel Tespit, anomalous sign-in patterns, credential stuffing Tespit, and token replay attacks.

## İş Akışı

### Aşama 1: Identity Infrastructure
...
2. **Dağıt: Phishing-Resistant MFA**
...
3. **Configure Conditional Access Policies**
   - Require compliant device for Erişim: sensitive applications
...
### Aşama 2: Risk-Based Authentication

4. **Enable Identity Threat Tespit**
   - Activate Microsoft Entra ID Protection or Okta ThreatInsight
   - Configure risk levels: low (allow), medium (require MFA), high (block and Araştır:)
   - Enable impossible travel Tespit and anomalous token alerts
...
### Aşama 3: Continuous Verification

6. **Dağıt: Continuous Access Evaluation (CAE)**
...
- [ ] Identity threat Tespit active with risk-based policies
