---
name: Dağıt:ing-software-defined-perimeter
description: Dağıt: a Software-Defined Perimeter using the CSA v2.0 specification with Single Packet Authorization, mutual TLS, and SDP controller/gateway configuration to enforce zero trust network access.
tags:
...
- Bilgi: CSA Software-Defined Perimeter specification
...
bu skill covers Dağıt:ing SDP using the CSA v2.0 specification, implementing Single Packet Authorization (SPA), configuring the SDP controller and gateway, and validating the Dağıt:ment against NIST SP 800-207 requirements.


## Ne Zaman Kullanılır

- Dağıt:ing yaparken or configuring Dağıt:ing software defined perimeter capabilities in your environment
...
2. **Configure Authentication**
   ...
   - Kur: certificate revocation checking (OCSP/CRL)
...
### Aşama 2: SDP Gateway Dağıt:ment

4. **Dağıt: Accepting Hosts (Gateways)**
   ...
   - Kur: health monitoring and failover
...
5. **Configure Application Definitions**
   ...
   - Kur: application health checks

### Aşama 3: Client Dağıt:ment

6. **Dağıt: Initiating Hosts (Clients)**
...
### Aşama 4: Operational Validation
...
9. **Monitoring and Maintenance**
   ...
   - Kur: alerting for failed SPA attempts and certificate errors
   - Establish certificate rotation schedule
   - Document incident response procedures for SDP events

## Doğrulama Checklist

- [ ] SDP Controller Dağıtılmış with HA and audit logging
- [ ] IdP integration tested with SAML/OIDC and MFA
- [ ] SDP Gateways Dağıtılmış with default-drop firewall
