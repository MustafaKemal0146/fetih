...
description: Develop and implement OT-specific incident response playbooks aligned with SANS PICERL framework, IEC 62443, and NIST SP 800-82 that address unique ICS challenges including safety-critical
  systems, limited downtime tolerance, and coordination between IT SOC, OT engineering, and plant operations teams.
tags:
- ics
- playbook
- ot-security
...
- building yaparken OT-specific incident response procedures for the first time
- existing yaparken: IT IR playbooks do not address ICS/SCADA-specific requirements
- preparing yaparken: for OT ransomware scenarios like EKANS or LockerGoga
- aligning yaparken: IR procedures with IEC 62443 and NERC CIP incident reporting requirements
- conducting yaparken post-incident reviews to improve OT IR capabilities

**Kullanma:** for IT-only incident response without OT components (use standard NIST 800-61 playbooks), for day-to-day OT security monitoring (see implementing-dragos-platform-for-ot-monitoring), or for tabletop exercise design (see performing-ics-tabletop-exercise).
...
### Adım 1: Define OT-Specific Incident Classification and Response Procedures
...
PICERL_PHASES = {
    ...
    "identification": {
        "description": "tespit etmeand confirm the OT security incident",
        "ot_specific": [
            ...
            "İncele: PLC mode changes (RUN/STOP/PROGRAM transitions)",
    ...
    "lessons_learned": {
        ...
        "ot_specific": [
            ...
            "Update Tespit rules based on observed attack techniques",
        ...
        return {
            ...
            OTIncidentCategory.SIS_COMPROMISE: {
                ...
                "containment_steps": [
                    ...
                    "Denetle: all engineering workstations for TRITON indicators",
                ],
                "recovery_priority": [
