...
### Adım 1: Prepare Collection Environment
```bash
...
### Adım 2: Capture System Memory (Highest Volatility)
```bash
...
### Adım 4: Capture Running Processes
```bash
...
### Adım 5: Capture Logged-in Users and Sessions
```bash
...
### Adım 6: Capture System Configuration State
```bash
...
### Adım 7: Hash All Evidence and Document Chain of Custody
```bash
cd "$EVIDENCE_DIR"
