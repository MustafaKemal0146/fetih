...
- conducting yaparken security assessments that involve performing threat modeling with owasp threat dragon
...
| D | tespit etme (ability) | Determining if data about a subject exists |
...
### Adım 2 --- Define the Scope

Before creating diagrams, Şunu belgele: scope:
...
### Adım 3 --- Create Data Flow Diagrams

In Threat Dragon, Şunu oluştur: new threat model and add diagrams using the following DFD elements:
...
- Reference threat model Bul:ings in security acceptance criteria
