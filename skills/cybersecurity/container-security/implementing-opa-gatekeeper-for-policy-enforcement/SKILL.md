...
- Dağıt:ing yaparken or configuring implementing opa gatekeeper for policy enforcement capabilities in your environment
...
1. **Start with dryrun** - Dağıt: constraints in `dryrun` mode first, review violations, then switch to `deny`
