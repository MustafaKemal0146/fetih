...
description: Implement eBPF-based runtime security observability and enforcement in Kubernetes clusters using Cilium Tetragon for kernel-level threat Tespit and policy enforcement.
tags:
- observability
- cilium
- runtime-security
...
- Dağıt:ing yaparken or configuring implementing runtime security with tetragon capabilities in your environment
...
- **File integrity monitoring**: tespit etmeunauthorized reads/writes to sensitive files
...
## Kurulum and Configuration

### Adım 1: Install Tetragon with Helm
...
### Adım 2: Install the Tetragon CLI
...
Şunu oluştur: TracingPolicy to tespit etmeprocesses attempting to escape container namespaces:
...
tespit etmereads of sensitive credentials:
