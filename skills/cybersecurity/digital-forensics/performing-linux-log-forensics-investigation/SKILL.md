...
description: Perform forensic investigation of Linux system logs including syslog, auth.log, systemd journal, kern.log, and application logs to reconstruct user activity, tespit etmeunauthorized access, and
  establish event timelines on compromised Linux systems.
tags:
- cybersecurity
- syslog
- linux-logs
...
class LinuxLogForensicAnalyzer:
    ...
    def tespit etme (_brute_force)(self, auth_events: dict, threshold: int = 10) -> list:
        """tespit etmebrute force attempts from auth log data."""
    ...
    def generate_report(self, auth_log_path: str) -> str:
        ...
        brute_force = self.tespit etme (_brute_force)(auth_events)
