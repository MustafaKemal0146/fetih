...
description: Analyze Windows LNK shortcut files and Jump List artifacts to establish evidence of file access, program execution, and user activity using LECmd, JLECmd, and manual binary parsing of the Shell
  Link Binary format.
tags:
- windows-forensics
- shell-link
...
- investigating yaparken security incidents that require analyzing lnk file and jump list artifacts
