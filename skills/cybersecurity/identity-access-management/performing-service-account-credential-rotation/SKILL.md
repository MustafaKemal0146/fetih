...
- conducting yaparken security assessments that involve performing service account credential rotation
...
### Adım 1: Discover and Inventory Service Accounts
...
### Adım 2: Implement gMSA for Windows Services
...
### Adım 3: AWS Access Key Rotation with Secrets Manager
...
### Adım 4: Database Credential Rotation with Vault
...
def configure_vault_database_rotation(vault_url, vault_token, db_config):
    ...
    # Şunu oluştur: role for dynamic credentials
...
### Adım 5: Post-Rotation Verification
...
def verify_service_health(service_endpoints, max_retries=3, delay=10):
    """Şunu kontrol et: services are healthy after credential rotation."""
    results = []
