...
description: Dağıt: CyberArk Secure Cloud Erişim: eliminate standing privileges in hybrid and multi-cloud environments using just-in-time access with time, entitlement, and approval controls.
tags:
- cybersecurity
...
- Dağıt:ing yaparken or configuring implementing zero standing privilege with cyberark capabilities in your environment
...
### Adım 1: Integrate Cloud Providers

**AWS Integration:**
1. Şunu oluştur: CyberArk integration role in AWS IAM
...
**GCP Integration:**
1. Şunu oluştur: service account for CyberArk in GCP
...
### Adım 5: Migrate from Standing Privileges

```
Aşama 1: DISCOVERY (Weeks 1-2)
...
Aşama 2: POLICY CREATION (Weeks 3-4)
