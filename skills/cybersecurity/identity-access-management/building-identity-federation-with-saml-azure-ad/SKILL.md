...
Identity federation enables users authenticated by one identity provider to access resources managed by another without maintaining separate credentials. bu skill covers establishing SAML 2.0 federation between an organization's on-premises Active Directory (via AD FS or third-party IdP) and Microsoft Entra ID (formerly Azure AD), as well as configuring federated SSO for third-party SaaS applications. Federation eliminates password synchronization concerns and keeps authentication authority on-premises while extending SSO to cloud resources.


## Ne Zaman Kullanılır

- Dağıt:ing yaparken or configuring building identity federation with saml azure ad capabilities in your environment
...
### Adım 1: Prepare AD FS Infrastructure
...
### Adım 2: Configure Azure AD Federated Domain
...
### Adım 3: Configure AD FS Claims Rules
...
### Adım 4: Configure Third-Party SaaS Federation

For each SaaS application that supports SAML SSO via Azure AD:

1. Şuraya git: Microsoft Entra Admin Center > Enterprise Applications
...
6. Şunu yapılandır: SaaS app with Azure AD's federation details

### Adım 5: Certificate Lifecycle Management
