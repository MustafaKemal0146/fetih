# FETIH Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.fetih/plugins/fetih-achievements/state.json` (existing unlock state)
  - `~/.fetih/plugins/fetih-achievements/scan_snapshot.json` (new)
  - `~/.fetih/plugins/fetih-achievements/scan_checkpoint.json` (new)
