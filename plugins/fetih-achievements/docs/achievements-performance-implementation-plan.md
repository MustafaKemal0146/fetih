# FETIH Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.fetih/plugins/fetih-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.fetih/plugins/fetih-achievements/scan_checkpoint.json`.
