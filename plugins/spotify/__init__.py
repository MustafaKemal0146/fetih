...
``_check_spotify_available()`` — when the user has not run ``fetih auth
spotify``, the tools remain registered (so they appear in ``fetih
...
The Spotify auth flow (``fetih auth spotify``), CLI plumbing, and docs
