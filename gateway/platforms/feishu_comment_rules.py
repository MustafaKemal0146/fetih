...
Config: ~/.fetih/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.fetih/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_fetih_home()`` helper (FETIH_HOME-aware and
...
RULES_FILE = get_fetih_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_fetih_home() / "feishu_comment_pairing.json"
