...
try:
    ...
    _FETIH_VERSION = "0.0.0"

_APP_VERSION = _FETIH_VERSION
_BOT_VERSION = _FETIH_VERSION
_YUANBAO_INSTANCE_ID = str(FETIH_INSTANCE_ID)  # single source: yuanbao_proto.FETIH_INSTANCE_ID
