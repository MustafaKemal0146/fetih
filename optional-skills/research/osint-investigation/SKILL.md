...
author: FETIH (adapted from ShinMegamiBoson/OpenPlanter, MIT)
metadata:
  hermes:
...
# $FETIH_OSINT_CACHE/icij/ (default: ~/.cache/hermes-osint/icij/).
...
# Set FETIH_OSINT_UA=your-app/1.0 (your@email) to identify yourself
