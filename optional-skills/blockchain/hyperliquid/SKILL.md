...
version: 0.1.0
author: Hugo Sequier (Hugo-SEQUIER), FETIH
license: MIT
...
The script reads `~/.fetih/.env` for two optional defaults:
...
Helper script: `~/.fetih/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.fetih/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.fetih/.env`.
...
```bash
python3 ~/.fetih/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.fetih/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
