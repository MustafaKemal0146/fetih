...
version: 1.0.0
author: Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), FETIH
license: MIT
...
Helper script path: `~/.fetih/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.fetih/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.fetih/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.fetih/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
