...
- User wants **FETIH itself to drive a browser** → use FETIH' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
