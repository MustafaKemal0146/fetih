...
```
SCRIPT=~/.fetih/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.fetih/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
