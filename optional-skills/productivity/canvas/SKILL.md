...
4. Name the token (e.g., "FETIH"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.fetih/.env`:
...
```bash
CANVAS="python $FETIH_HOME/skills/productivity/canvas/scripts/canvas_api.py"
