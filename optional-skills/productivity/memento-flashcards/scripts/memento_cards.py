...
Data file: $FETIH_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_FETIH_HOME = Path(os.environ.get("FETIH_HOME", Path.home() / ".fetih"))
DATA_DIR = _FETIH_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
