...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("fetih_cli.config.get_config_path", return_value=config_path), \
             patch("fetih_cli.config.ensure_fetih_home"):
    ...
    def test_save_env_value_sets_0600(self):
        ...
        with patch("fetih_cli.config.get_env_path", return_value=env_path), \
             patch("fetih_cli.config.ensure_fetih_home"):
    ...
    def test_ensure_fetih_home_sets_0700(self):
        home = Path(self.tmpdir) / ".fetih"
        with patch("fetih_cli.config.get_fetih_home", return_value=home):
