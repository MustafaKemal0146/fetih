...
# FETIH (https://x.ai/news/grok-fetih), making that hint actively wrong:
...
def test_summarize_api_error_surfaces_xai_entitlement_body_verbatim():
    """xAI's OAuth 403 body must surface as-is, with no FETIH-side hint."""
    from run_agent import AIAgent
    ...
    # No stale claim that X Premium is incompatible with FETIH.
...
def test_grok_4_3_context_length_is_1m():
    ...
    FETIH' substring-match fallback used to return 256k (from the
