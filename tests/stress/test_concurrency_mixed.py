...
def worker_loop(worker_id: int, fetih_home: str, result_file: str) -> None:
...
def reclaimer_loop(fetih_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="fetih_mixed_stress_")
    print(f"FETIH_HOME = {home}")
