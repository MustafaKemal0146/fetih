...
def _ensure_redaction_enabled(monkeypatch):
    """Ensure redaction is active regardless of host FETIH_REDACT_SECRETS."""
    monkeypatch.delenv("FETIH_REDACT_SECRETS", raising=False)
...
class TestBrowserSecretExfil:
    ...
    def test_allows_normal_url(self):
        ...
        from tools.browser_tool import browser_navigate
        result = browser_navigate("https://github.com/MustafaKemal0146/fetih")
        parsed = json.loads(result)
