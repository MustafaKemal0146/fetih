...
def test_import_loads_env_from_fetih_home(tmp_path, monkeypatch):
    home = tmp_path / ".fetih"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-fetih-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-fetih-home"
