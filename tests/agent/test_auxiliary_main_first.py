...
Prior to this change, aggregator users (OpenRouter / FETIH Portal) had aux
...
class TestResolveAutoMainFirst:
    ...
    def test_nous_main_uses_main_model_for_aux(self, monkeypatch):
        """FETIH Portal main user → aux uses their picked Nous model, not free-tier MiMo."""
...
class TestResolveVisionMainFirst:
    ...
    def test_copilot_vision_sets_vision_header(self, monkeypatch):
        ...
        with patch(
            ...
            "fetih_cli.auth.resolve_api_key_provider_credentials",
            return_value={
                "provider": "copilot",
            ...
            "fetih_cli.copilot_auth.copilot_request_headers",
