...
class TestDefaultContextLengths:
    ...
    def test_deepseek_v4_models_1m_context(self):
        ...
        # / FETIH Portal) to 1M without probing down to the legacy 128K
...
# =========================================================================
# FETIH Portal context-window resolution (provider="nous")
# =========================================================================

class TestNousPortalContextResolution:
    """FETIH Portal /v1/models is authoritative for what Nous infra enforces
    ...
    def test_bypass_keyed_on_url_not_provider_string(
        ...
        when the user is really on FETIH Portal (e.g. cred-pool fallback).
