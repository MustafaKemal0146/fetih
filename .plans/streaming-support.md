# Streaming LLM Response Support for FETIH
...
```
FETIH_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("FETIH_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `fetih_cli/config.py` | 1 | +streaming config defaults |
